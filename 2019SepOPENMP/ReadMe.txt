...
This project consists of a set of OpenMP coding exercise used for my introductory OPENMP workshop at the Indian Institute of Science (Bangalore), Supercomputing Center.There are several workshops on parallel programming conducted annually. Code for the first revision is from my 5th workshop and the most recent one in September 2019. (http://www.serc.iisc.ac.in/short-course-on-introduction-to-hpc-13th-14th-september-2019/) Programs are primarily written in C or C++. An attempt has been made to write the same programs in fortran too, but that is still incomplete. I hope to complete it before the next workshop or when I find enough time.
